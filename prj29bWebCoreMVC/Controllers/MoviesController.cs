...
namespace prj29bWebCoreMVC.Controllers
{
    ...
    {
        private readonly prj29bWebCoreMVCContext _context;

        public MoviesController(prj29bWebCoreMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            if (_context.Movie == null)
            {
                return Problem("Entity set 'prj29bWebCoreMVCContext.Movie'  is null.");
            }
            var movie = await _context.Movie.FindAsync(id);
            if (movie != null)
            {
